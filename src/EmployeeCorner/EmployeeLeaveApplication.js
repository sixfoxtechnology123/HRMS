...
const EmployeeLeaveApplication = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5001/api/employee-ids/details/${loggedUser.employeeId}`)
      .then((res) => {
        const emp = res.data;
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5001/api/leave-allocation/${employee.employeeID}`)
  ...
  <div className="flex min-h-screen bg-gray-100">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input type="text" className= "w-full pl-2 pr-1 border border-gray-300 font-medium rounded text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-400 transition-all duration-150 cursor-not-allowed bg-gray-100" value={formData.employeeId} readOnly />
        </div>

        {/* Employee Name */}
        <div>
          <label className="font-semibold">Employee Name</label>
          <input type="text"className= "w-full pl-2 pr-1 border border-gray-300 font-medium rounded text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-400 transition-all duration-150 cursor-not-allowed bg-gray-100"  value={formData.employeeName} readOnly />
        </div>

        {/* Application Date */}
        <div>
          <label className="font-semibold">Application Date</label>
          <input type="date" className= "w-full pl-2 pr-1 border border-gray-300 font-medium rounded text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-400 transition-all duration-150 cursor-not-allowed bg-gray-100"  value={formData.applicationDate} readOnly />
        </div>
        ...
        <div>
          ...
          <input type="text" className={inputClass} value={leaveInHand} readOnly />
        </div>
        ...
        <div>
          ...
          <input type="number" className= "w-full pl-2 pr-1 border border-gray-300 font-medium rounded text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-400 transition-all cursor-not-allowed bg-gray-100 duration-150"  value={formData.noOfDays} readOnly />
        </div>
