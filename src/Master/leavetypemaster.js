...
const LeaveTypeMaster = () => {
  ...
  try {
    ...
    // now this will run without being cancelled
  ...
  return (
    <div className="min-h-screen bg-zinc-300 flex items-center justify-center">
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-6xl">
        ...
        <form onSubmit={handleSaveOrUpdate} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-1 border rounded" placeholder="Casual, Sick, Maternity, etc"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-1 border rounded" placeholder="e.g., CL, SL"
          />
        </div>
       ...
       <div className="col-span-1 md:col-span-2 lg:col-span-3 flex justify-between mt-2">
            {/* Prevent BackButton from acting like submit */}
